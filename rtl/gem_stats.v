...
// two ways to do that. Counting in rx_clk and synchronising eight 32-bit values
// across means eight multi-bit crossings, each needing its own handshake or
// Gray coding; carrying one event per class across and counting on this side
// means eight single-bit crossings through a structure whose safety argument
